...
import "./Beauty_Parlor_Demo.scss";
...
east
  ...
  return (
    <div className="beauty_parlor_demo_container">
      <div className="beauty_parlor_box">
        ...
        <div className="row_1">
          ...
          <div className="banner_image">
            <img
              src="https://img.freepik.com/free-vector/flat-geometric-beauty-youtube-thumbnail_23-2148914042.jpg?t=st=1724511121~exp=1724514721~hmac=f3f09c514b99c6d49cb4188bab650dca8d357f4f9763721c780ac9afab091bd5&w=1060"
              alt="banner"
            />
            <div className="overlay"></div>
          </div>
        ...
        {/* Services */}
        <div className="row_4">
          <div className="beauty_parlor_title_demo">
            <h3>Our Services</h3>
...
export default Beauty_Parlor_Demo;
