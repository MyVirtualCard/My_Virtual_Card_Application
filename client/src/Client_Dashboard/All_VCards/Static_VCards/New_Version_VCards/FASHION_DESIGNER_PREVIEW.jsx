...
import "./FASHION_DESIGNER_PREVIEW.scss";
//service Slider
...
const FASHION_DESIGNER_PREVIEW = () => {
  let style = {
  ...
  return (
    <div className="FASHION_DESIGNER_PREVIEW_CONTAINER">
      {/* Gallery Full IMAGE */}
      <div
      ...
      <div className="FASHION_DESIGNER_PREVIEW_CARD">
        {/* Banner and logo */}
        <div className="Image_row_1" ref={HomeRef}>
          <div className="banner_image">
            <img
              src="https://img.freepik.com/premium-photo/fashion-designer-sketching-new-designs_155807-37539.jpg?uid=R79330344&ga=GA1.1.111147909.1717157513&semt=ais_hybrid"
              alt="banner"
            />
          ...
          <div className="user_logo">
            <div className="logo">
            <img
              src="https://img.freepik.com/free-vector/circular-fashion-logo-template_23-2150225783.jpg?uid=R79330344&ga=GA1.1.111147909.1717157513&semt=ais_hybrid"
              alt="user_logo"
            />
            </div>
        ...
        <div className="about_row_4" ref={AboutRef}>
          <div className="FASHION_DESIGNER_PREVIEW_DEMO_TITLE">
            <h3># &nbsp;About Us</h3>
          </div>
          ...
          <div className="FASHION_DESIGNER_PREVIEW_DEMO_SUB_TITLE">
...
export default FASHION_DESIGNER_PREVIEW;
