...
import "./FASHION_DESIGNER_LIVE.scss";
//service Slider
...
END:VCARD
  ...
  return (
   ...
   {VCard_URL_Data.length > 0 ? 
    <div className="FASHION_DESIGNER_LIVE_CONTAINER">
    {/* Gallery Full IMAGE */}
    <div
      ...
      {AboutData.length > 0 ? (
        <>
          <div className="about_row_4" ref={AboutRef}>
            <div className="FASHION_DESIGNER_LIVE_TITLE">
              <h3># &nbsp;About Us</h3>
            </div>
...
export default FASHION_DESIGNER_LIVE;
