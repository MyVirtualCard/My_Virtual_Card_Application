              ...
              <div className="Real_Estate_box">
                ...
                {BasicData.length > 0 ? (
                  <div className="row_2">
                    ...
                    <div className="summary">
                      <p>
                        {VCard_URL_Data[0].Description || `No Description!`}
                      </p>
                    </div>
                  </div>
                ) : (
                      ...
                      return (
                        <div className="contact_list_container" key={index}>
                          ...
                          >
                            ...
                            <div className="list_detail">
                              <p>{data.MobileNumber?`(+91) ${data.MobileNumber}`:"(+91) -----------"}</p>
                            </div>
                          </a>
                ...
                ManageContentData[0].Service == true ? (
                  <div className="row_4">
                    <div className="realestate_title">
                      <h3>Our Services</h3>
                    </div>
                    ...
                    <div className="qr_code_box">
                      ...
                      {QRCodeData.map((data,index)=>{
                        return(
                          ...
                          <div className="user_logo">
                          <img
                              src={VCard_URL_Data[0].Profile || VCard_URL_Data[0].ProfileAddress}
                              alt="user_logo"
                            />
                          </div>
                          ...
                          <div className="qr">
                            <img
                              src={data.QRCodeImage ||`https://img.freepik.com/premium-photo/qr-code-area-3d-illustration_118019-6664.jpg?w=740`}
                              alt=""
                            />
                          </div>
                        </div>
