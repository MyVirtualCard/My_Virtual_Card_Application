  ...
  return(
    ...
    <div className="contact_list">
      ...
      <div className="list_detail">
        <small>Email</small>
        <p>{data.Email || 'info@yourdomain.com'}</p>
      </div>
    </div>
    <div className="contact_list">
    ...
    <div className="service_list" key={index}>
      ...
      <div className="service_detail">
        <div className="service_title">
          <h4>{data.ServiceName || 'Physical Fitness'}</h4>
        </div>
        <div className="service_summary">
          <p>
            {data.ServiceDescription || `Physical fitness is a form of physical fitness
            ...
            groups`}
                    ...
                    >
                      {ProductData.map((data,index)=>{
                        ...
                        return(
                          ...
                          <div className="product_image">
                            <img
                              src={data.ProductImage !=undefined || data.ProductImage !=null ? data.ProductImage : `https://img.freepik.com/free-photo/3d-gym-equipment_23-2151114181.jpg?t=st=1722480930~exp=1722484530~hmac=b3e99f19f2f2261ec0d7c5f1da8914dbfa376f325e37125598579ea7d7eced3b&w=900`}
                              alt="product"
                            />
                          </div>
                      ...
                      <div className="product_list">
                        ...
                        <div className="product_details">
                          ...
                          <small>
                            {" "}
                            Hexa Brand Black Weight lifter Full set
                          </small>
                ...
                {/* //Appinment */}
                {VCard_URL_Data.length > 0 && BasicData.length> 0 && SocialMediaData.length>0 ? 
                <>
                                <div className="row_6">
                  <div className="title">
                    <h3>
                    ...
                    <div className="gallery_box">
                      ...
                      {GalleryData.map((data,index)=>{
                        return(
                          <div key={index}>
   <img
                        src={data.GalleryImage || "https://img.freepik.com/free-photo/young-adult-doing-indoor-sport-gym_23-2149205565.jpg?t=st=1722483193~exp=1722486793~hmac=582b97347ecbf83a7f71abf16c7dc7dc6287bdaa892fd409e0391f81788d2e1a&w=900"}
                        alt="developer"
                      ...
                      {TestimonialData.map((data,index)=>{
                        return(
                          ...
                          <div className="client_feedback">
                            <small>
                             {data.ClientFeedback || ` Lorem ipsum dolor, sit amet consectetur adipisicing
                          ...
                          <div className="client_detail">
                            <img
                              src={data.ClientImage || "https://img.freepik.com/premium-vector/avatar-icon003_750950-54.jpg?w=740"}
                              alt=""
                            />
                            ...
                            <div className="message" key={index}>
                              <div className="user_detail">
                                <div className="profile">
                                  <img src='https://img.freepik.com/free-vector/isolated-young-handsome-man-different-poses-white-background-illustration_632498-859.jpg?t=st=1722896783~exp=1722900383~hmac=3628f6befbe82fb4e2642e0c0f1f836c946ba70bb2e17c5d12d5c839123aeb12&w=740' alt="profile" />
                                </div>
