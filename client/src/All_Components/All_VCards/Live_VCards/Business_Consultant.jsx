                      ...
                      {VCard_URL_Data.map((data, index) => {
                        return (
                          <div className="summary" key={index}>
                            <p>{data.Description || "No Summary Added!"}</p>
                          </div>
                        );
                      })}
                    </div>
                            ...
                            return (
                              <div key={index}>
                                {data.ServiceType == "Icon_Tag" ? (
                                  <>
                                    {/* //service_icon list */}
                                    <a href={data.ServiceURL} className="service_list">
                                    <HtmlRenderer
                                      htmlString={data.ServiceIcon}/>

                                      <div className="service_detail">
                                        <div className="service_title">
                                          <h4>{data.ServiceName || 'No Service Name'}</h4>
                                        </div>
                                        <div className="service_summary">
                                          <p>
                                           {data.ServiceDescription || 'NoDescription'}
                                          </p>
                                        </div>
                                      </div>
                                    </a>
                               ...
                               <>
    {/* //service_image list */}
    <a href={data.ServiceURL}  className="img_service_list">
                      ...
                      {ProductData.map((data,index)=>{
                       ...
                       />
                        ...
                        <div className="product_details">
                          ...
                          <div className="link">
                            <a href={data.ProductURL}>More Detail</a>
                          </div>
                        </div>
                      </div>
                          </>
