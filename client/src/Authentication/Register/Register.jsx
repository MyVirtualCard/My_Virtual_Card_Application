      ...
      await api
        ...
        .then((res) => {
          ...
          localStorage.setItem(
            "mobileNumber",
            JSON.stringify(res?.data?.mobileNumber)
          );
        })
        .catch((error) => {
          console.log(error);
        ...
        <div className="logo_for_small_device">
          ...
          <div className="right_side">
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="profile">
                <label htmlFor="profile">
                  <img
                    src={
                      preview ||
                      "https://img.freepik.com/premium-photo/round-circle-with-mans-head-circle-with-circle-middle_807814-680.jpg?w=740"
                    }
                    alt="avatar"
                    id="profile_image"
                  />
              ...
              <div className="or">
                <Link to="/login">
                  Already u have an account ? <span>Sign In</span>
                </Link>
              </div>
            </form>
          </div>
