                  ...
                  <div className="svg_image">
                    ...
                    >
                      <path
                        fill="#B75A48"
                        fill-opacity="1"
                        d="M0,0L48,37.3C96,75,192,149,288,176C384,203,480,181,576,154.7C672,128,768,96,864,117.3C960,139,1056,213,1152,213.3C1248,213,1344,139,1392,101.3L1440,64L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
                      ></path>
                    </svg>
                  </div>
                </div>
...
"
            ...
            {LocalVideoData.length > 0 ? (
              <>
                <div className="local_video" ref={VideoRef}>
                  {/* <div className="CAB_DRIVERS_TITLE_LIVE">
                    <h3>Local Videos</h3>
                    <span className="material-symbols-outlined">
                      video_library
                  ...
                  <div className="local_videos_container">
                    {LocalVideoData[0].videos.map((data, index) => {
                      return (
                        <div className="video_image" key={index}>
