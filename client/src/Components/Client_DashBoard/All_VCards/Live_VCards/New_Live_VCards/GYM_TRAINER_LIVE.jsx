...
END:VCARD
  ...
  return (
    ...
    {VCard_URL_Data.length>0 ? 
       <div className="GYM_TRAINER_LIVE_CONTAINER">
       {/* Gallery Full IMAGE */}
       <div
       ...
       <div className="GYM_TRAINER_LIVE_CARD">
         {/* Banner and logo */}
                   ...
                   <div className="user_details">
                     <div className="user_data">
                       <div className="user_information">
                         ...
                         <p>
                           {VCard_URL_Data[0].Profession || "Corporate Company"}
                         </p>
                       </div>
             ...
             {BasicData.map((data, index) => {
               return (
                 <div className="contact_row_3" key={index}>
                   ...
                   {/* PhoneNumber */}
                   <a
                     href={`tel:+91${data.MobileNumber ? data.MobileNumber : "#"}`}
                     target="_blank"
                   >
                     <div className="icon">
                       <BiSolidPhoneCall />
             ...
             {AboutData.map((data, index) => {
               return (
                 <div className="about_row_4" ref={AboutRef} key={index}>
                   <div className="GYM_TRAINER_LIVE_TITLE">
                     <h3>
                       About Us
                   ...
                   return (
                     <div className="Service" key={index}>
                       ...
                       <div className="service_description">
                         <p>
                           <HtmlRenderer htmlString={data.ServiceDescription} />
                         </p>
                       </div>
                   ...
                   return (
                     <div className="Product" key={index}>
                       ...
                       <div className="product_description">
                         <p>
                           <HtmlRenderer htmlString={data.ProductDescription} />
                         </p>
                       </div>
...
export default GYM_TRAINER_LIVE;
