      ...
      {VCard_URL_Data.length > 0 ? (
        <div className="Corporate_Company_container">
          {VCard_URL_Data.length > 0 ? (
            <>
              <Helmet>
                <title>{VCard_URL_Data[0].Profession}</title>
                <meta
                  name="description"
                  content={`Hi There! ,Welcome to ${VCard_URL_Data[0].Profession} .. Visit Our Site to get your Product and Services u have .. Contact Us Easily by one click....`}
                />
