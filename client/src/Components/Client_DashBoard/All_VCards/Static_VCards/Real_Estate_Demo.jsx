      ...
      <div className="Business_Consultant_box">
        ...
        <div className="row_1">
          ...
          <div className="user_logo">
            <img
              src="https://img.freepik.com/premium-photo/creative-architecture-model-presentation-by-stylish-cartoon-man-suit_893571-59186.jpg?w=900"
              alt="user_logo"
            />
          </div>
        </div>
        ...
        {/* Services */}
        <div className="row_4">
          <div className="realestate_title_demo">
            <h3>Our Services</h3>
          </div>
...
export default Real_Estate_Demo;
