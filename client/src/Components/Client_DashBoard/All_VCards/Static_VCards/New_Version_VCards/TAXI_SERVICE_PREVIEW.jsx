...
const TAXI_SERVICE_PREVIEW = () => {
  ...
  return (
    <div className="TAXI_DRIVER_PREVIEW_CONTAINER">
      {/* Gallery Full IMAGE */}
      <div
      ...
      <div className="TAXI_DRIVER_PREVIEW_CARD">
        {/* Banner and logo */}
        <div className="Image_row_1" ref={HomeRef}>
          <div className="banner_image">
            <img
              src="https://img.freepik.com/premium-photo/taxi-car-street-night-luminous-taxi-sign-bokeh-background-taxi-sign-roof-car_1199132-234013.jpg?uid=R79330344&ga=GA1.1.111147909.1717157513&semt=ais_hybrid"
              alt="banner"
            />
        ...
        <div className="about_row_4" ref={AboutRef}>
          <div className="TAXI_DRIVER_PREVIEW_DEMO_TITLE">
