...
router.post("/:URL_Alies", verifyToken,ProductUpload.single('ProductImage'), PostProductData);
...
router.put("/updateID/:id", verifyToken,ProductUpload.single('ProductImage'), updateSpecificUserData);
