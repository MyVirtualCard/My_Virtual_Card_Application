...
let Vcard_URL_Schema=new mongoose.Schema({
    ...
    Profile:{
        type:String,
        default:'https://img.freepik.com/free-vector/red-logo-black-background_1195-52.jpg?t=st=1723040744~exp=1723044344~hmac=8957c7841606fcccd1da5549120aead8a75bdac9544c7484c2193bc6caf2298e&w=740'
        // required:true
    },
    Banner:{
    type:String,
