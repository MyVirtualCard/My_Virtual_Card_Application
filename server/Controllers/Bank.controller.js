...
export const getBankAllData = async (req, res) => {
  try {
...
export const postBank = async (req, res) => {
  if (!req.body.URL_Alies || !req.body.HolderName || !req.body.BankName || !req.body.AccountType || !req.body.IFSCCode || !req.body.AccountNumber) {
...
export const readSpecificUserAllData = async (req, res) => {
  try {
    let getSpecificData = await BankModel.find({
      URL_Alies: req.params.URL_Alies,
    });
...
export const readSpecificIdUserData = async (req, res) => {
  try {
    let { id } = req.params;
    let getSpecificIdData = await BankModel.findById(id);
